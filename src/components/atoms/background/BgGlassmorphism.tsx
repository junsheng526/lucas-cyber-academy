...
const BgGlassmorphism: FC<BgGlassmorphismProps> = ({
  ...
  return (
    ...
    >
      ...
      <span className="block bg-[#04868b] w-72 h-72 -ml-20 mt-40 rounded-full mix-blend-multiply filter blur-3xl opacity-10 lg:w-96 lg:h-96 animate-[delay_2000ms]"></span>
    </div>
  );
};
